...
public static Seven instance;

public int LevelNumber = 0;

public int Targetnumber = 7; //change the "7" to a variable and will be able to changed every level
...
private int SystemScore = 0;
    ...
    private void If7() //the function to complete task2
    {
        ...
        if (number % Targetnumber == 0) //desicribe the condition
        {
            DividedBy7 = true;
        }
